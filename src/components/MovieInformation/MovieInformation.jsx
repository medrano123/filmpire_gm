...
import { Movie as MovieIcon, Theaters, Language, PlusOne, Favorite, FavoriteBorderOutlined, Remove, ArrowBack, Splitscreen } from '@mui/icons-material';
		...
		<Grid container className={classes.containerSpaceAround}>
			...
			<Grid item container direction="column" lg={7}>
				...
				<Grid item className={classes.genresContainer}>
					{data?.genres?.map((genre, index)=> (
						<Link key={genre.name} className={classes.links} to="/" 
							...
							<Typography color="text-primary" varian="subtitle1" >
								{genre?.name}
							</Typography>
					</Link>	
				))} 
				...
				<Grid item container spacing={2}>
					...
					)).splice(0,12)} {/* add .slice(0,6) if YOU want*/}
				</Grid>
